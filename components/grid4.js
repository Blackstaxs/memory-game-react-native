...
<View style={styles.container}>
	  ...
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card1 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button2} onPress={() => this.card11Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card11 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button3} onPress={() => this.card2Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card2 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button4} onPress={() => this.card22Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card22 }}>
	  </Image>
	  </TouchableHighlight>
...
<View style={styles.container}>
	  ...
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card3 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button6} onPress={() => this.card33Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card33 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button7} onPress={() => this.card4Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card4 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button8} onPress={() => this.card44Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card44 }}>
	  </Image>
	  </TouchableHighlight>
...
<View style={styles.container}>
	  ...
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card5 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button10} onPress={() => this.card55Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card55 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button11} onPress={() => this.card6Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card6 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button12} onPress={() => this.card66Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card66 }}>
	  </Image>
	  </TouchableHighlight>
...
<View style={styles.container}>
	  ...
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card7 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button2} onPress={() => this.card77Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card77 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button3} onPress={() => this.card8Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card8 }}>
	  </Image>
	  </TouchableHighlight>
	  
	  <TouchableHighlight disabled={this.state.button4} onPress={() => this.card88Change()}>
	  <Image style={{ width: 50, height: 80, margin: 9 }} source={{ uri: this.state.card88 }}>
	  </Image>
	  </TouchableHighlight>
